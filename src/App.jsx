...
//               <p className="couple-name">R. Sudhakar B.Sc,M.PEd,PhD</p>
...
//             <p className="blessing-names">N.Meenachi Sundharam., R. Surya B.E., R. Sathish DME, BA.History, R. Krishna Veni B.E.</p>
//             <p><span className="blessing-label">With Love from</span></p>
//             <p className="blessing-names">D. Elavarasi B.Sc , B.Ed & D. Petchiammal</p>
...
function RSVPSuccessPopup({ guestName, onClose }) {
  return (
    <div className="rsvp-popup-overlay" onClick={onClose}>
      <div className="rsvp-popup-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="popup-content">
          ...
          <p className="popup-subtitle">Your RSVP has been received</p>
          
          <div className="popup-message">
            <p>Dear <span className="guest-name">{guestName}</span>,</p>
            <p>We are delighted that you will be joining us on this special day. We look forward to celebrating with you and creating beautiful memories together.</p>
            <p className="popup-confirmation">Your response has been recorded and we will reach out shortly to confirm the details.</p>
          </div>
          ...
          <div className="popup-footer-text">
            <p className="quote">"With love and blessings"</p>
          </div>
        </div>
...
export default function App() {
  ...
  const handleRSVPSubmit = (e) => {
    ...
    // Show popup with guest name
    setPopupGuestName(formData.guestName);
  ...
  return (
    <div className="wedding-website">
      ...
      {/* ==================== RSVP SUCCESS POPUP ==================== */}
      {showRSVPPopup && (
        <RSVPSuccessPopup guestName={popupGuestName} onClose={handleClosePopup} />
      )}
