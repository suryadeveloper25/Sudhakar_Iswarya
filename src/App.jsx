...
// import './App.css';
// import { Heart, Music, Volume2, VolumeX, MapPin, Calendar, Search, Send,Users,CalendarDays ,Utensils,MessageSquareHeart } from 'lucide-react';
...
//     e.preventDefault();
//     alert('Thank you for your RSVP! We will confirm shortly.');
//     setFormData({
//       guestCount: '1 Guest',
//       events: ['WEDDING CEREMONY', 'RECEPTION'],
//       dietary: '',
...
//               {/* <p className="event-description">Dinner, dancing, and celebration</p> */}
//               <div className="event-buttons">
...
//                   {/* <h6 className="date-title">Save the Date</h6> */}
